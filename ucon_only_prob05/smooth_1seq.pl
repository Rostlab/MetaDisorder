...
$fout="$work_dir/$id.ucon_only_prob05";
...
sub convert {
        ...
        for ($c=0;$c<scalar@e;$c++) {
                ...
                elsif (($e[$c]>=0.54) &&($e[$c]<0.55)) {
                        $e1[$c]=90;
                        }
                elsif (($e[$c]>=0.55) &&($e[$c]<0.56)) {
                        $e1[$c]=80;
                        }
                elsif (($e[$c]>=0.56) &&($e[$c]<0.57)) {
                        $e1[$c]=70;
                        }
                elsif (($e[$c]>=0.57) &&($e[$c]<0.58)) {
                        $e1[$c]=60;
                        }
                elsif (($e[$c]>=0.58) &&($e[$c]<0.62)) {
                        $e1[$c]=50;
                        }
                elsif (($e[$c]>=0.62) &&($e[$c]<0.63)) {
                        $e1[$c]=40;
                        }
                elsif (($e[$c]>=0.63) &&($e[$c]<0.64)) {
                        $e1[$c]=30;
                        }
                elsif (($e[$c]>=0.64) &&($e[$c]<0.65)) {
                        $e1[$c]=20;
                        }
                elsif (($e[$c]>=0.65) &&($e[$c]<0.66)) {
                        $e1[$c]=10;
                        }
                }
        return @e1;
